...
describe('PUT /v1/admin/quiz/:quizid/name', () => {
  ...
  describe('error testing', () => {
    ...
    },
    {
      ...
      const res = request('PUT', SERVER_URL + `/v1/admin/quiz/${quiz.quizId}/name`, {
        json: {
          token: token.token,
          name: name
        },
    ...
    test('returns an error for invalid quizId', () => {
      const res = request('PUT', SERVER_URL + `/v1/admin/quiz/${quiz.quizId + 1}/name`, {
        json: {
          token: token.token,
          name: 'Quiz2'
        },
    ...
    test('returns an error for a quiz not owned by this user', () => {
      ...
      const res = request('PUT', SERVER_URL + `/v1/admin/quiz/${quiz2.quizId}/name`, {
        json: {
          token: token.token,
          name: 'Quiz2'
        },
  ...
  describe('functionality testing', () => {
    ...
    test('successfully updates the name of a quiz and timeLastEdited', () => {
      request('PUT', SERVER_URL + `/v1/admin/quiz/${quiz.quizId}/name`, {
        json: {
          token: token.token,
          name: 'New quiz1'
        },
    ...
    test('successfully updates the name of multiple quizzes', () => {
      ...
      request('PUT', SERVER_URL + `/v1/admin/quiz/${quiz2.quizId}/name`, {
        json: {
          token: token.token,
          name: 'New quiz2'
        },
