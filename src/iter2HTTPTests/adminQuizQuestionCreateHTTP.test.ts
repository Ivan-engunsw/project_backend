...
describe('POST /v1/admin/quiz/{quizid}/question', () => {
  ...
  describe('error testing', () => {
    test('returns an error for invalid question length', () => {
      ...
      const res1 = request('POST', SERVER_URL + `/v1/admin/quiz/${quiz.quizId}/question`, {
        json: {
          token: token.token,
          questionBody: inputQuestion
        },
        timeout: TIMEOUT_MS
      });
      ...
      const res2 = request('POST', SERVER_URL + `/v1/admin/quiz/${quiz.quizId}/question`, {
        json: {
          token: token.token,
          questionBody: inputQuestion
        },
    ...
    test('returns an error for invalid duration', () => {
      ...
      const res = request('POST', SERVER_URL + `/v1/admin/quiz/${quiz.quizId}/question`, {
        json: {
          token: token.token,
          questionBody: inputQuestion
        },
    ...
    test('returns an error when question causes quiz duration to exceed 3 minutes', () => {
      request('POST', SERVER_URL + `/v1/admin/quiz/${quiz.quizId}/question`, {
        json: {
          token: token.token,
          questionBody: inputQuestion
        },
    ...
    test('returns an error for an invalid quizId', () => {
      const res = request('POST', SERVER_URL + `/v1/admin/quiz/${quiz.quizId + 1}/question`, {
        json: {
          token: token.token,
          questionBody: inputQuestion
        },
  ...
  describe('functionality testing', () => {
    ...
    test('correctly creates multiple questions', () => {
      const resQues1 = request('POST', SERVER_URL + `/v1/admin/quiz/${quiz.quizId}/question`, {
        json: {
          token: token.token,
          questionBody: inputQuestion
        },
      ...
      const resQues2 = request('POST', SERVER_URL + `/v1/admin/quiz/${quiz.quizId}/question`, {
        json: {
          token: token.token,
          questionBody: questionBody
        },
