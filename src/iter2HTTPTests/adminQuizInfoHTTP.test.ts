...
describe('GET /v1/admin/quiz/:quizid', () => {
  describe('adminQuizInfo HTTP tests', () => {
    ...
    test('Quiz ID does not refer to a valid quiz', () => {
      ...
      const res = request('GET', SERVER_URL + `/v1/admin/quiz/${quiz.quizId + 1}`, {
        qs: {
          token: token.token
        },
        timeout: TIMEOUT_MS
    ...
    test('Successfully view multiple quizzes', () => {
      ...
      const res1 = request('GET', SERVER_URL + `/v1/admin/quiz/${quiz1.quizId}`, {
        qs: {
          token: token1.token
        },
        timeout: TIMEOUT_MS
      ...
      const res3 = request('GET', SERVER_URL + `/v1/admin/quiz/${quiz3.quizId}`, {
        qs: {
          token: token2.token
        },
        timeout: TIMEOUT_MS
