...
describe('adminQuizRestore', () => {
  ...
  test('Quiz ID refers to a quiz that is not currently in the trash', () => {
    ...
    const res = request('POST', SERVER_URL + `/v1/admin/quiz/${quiz.quizId}/restore`, {
      json: {
        token: token.token
      },
      timeout: TIMEOUT_MS
  ...
  test('Quiz ID does not refer to a valid quiz', () => {
    ...
    const res = request('POST', SERVER_URL + `/v1/admin/quiz/${quiz.quizId + 1}/restore`, {
      json: {
        token: token.token
      },
      timeout: TIMEOUT_MS
  ...
  test('Successfully restore one quiz', () => {
    ...
    const infoBef = request('GET', SERVER_URL + '/v1/admin/quiz/list', {
      qs: {
        token: token.token
      },
      timeout: TIMEOUT_MS
    ...
    const trashBef = request('GET', SERVER_URL + '/v1/admin/quiz/trash', {
      qs: {
        token: token.token
      },
      timeout: TIMEOUT_MS
    ...
    request('POST', SERVER_URL + `/v1/admin/quiz/${quiz.quizId}/restore`, {
      json: {
        token: token.token
      },
      timeout: TIMEOUT_MS
    ...
    const infoAft = request('GET', SERVER_URL + '/v1/admin/quiz/list', {
      qs: {
        token: token.token
      },
      timeout: TIMEOUT_MS
    ...
    const trashAft = request('GET', SERVER_URL + '/v1/admin/quiz/trash', {
      qs: {
        token: token.token
      },
      timeout: TIMEOUT_MS
  ...
  test('Successfully restore multiple quizzes', () => {
    ...
    request('POST', SERVER_URL + `/v1/admin/quiz/${quiz1.quizId}/restore`, {
      json: {
        token: token.token
      },
      timeout: TIMEOUT_MS
    });
    request('POST', SERVER_URL + `/v1/admin/quiz/${quiz2.quizId}/restore`, {
      json: {
        token: token.token
      },
      timeout: TIMEOUT_MS
